...
router.post("/", CommentValidation.validateComment, ArticleCommentService.createComment);
router.put("/:id", CommentValidation.validateComment, ArticleCommentService.updateComment);
