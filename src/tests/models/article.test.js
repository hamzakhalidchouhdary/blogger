...
describe('Article Model', function() {
  ...
  describe('Modify Article', function(){
    ...
    it('should update article title', async function() {
      ...
      const updatedArticle = await ArticleFixtures.findArticleById(this.article.id);
  ...
  describe('findByAuthorId', function() {
    ...
    it('should find article by it`s author id', async function() {
      ...
      expect(_.map(articles, 'id')).to.have.members([this.article1.id, this.article2.id]);
  ...
  describe('remove article', function() {
    ...
    it('should find article by it`s author id', async function() {
      ...
      const deletedArticle = await ArticleFixtures.findArticleById(this.article1.id);
